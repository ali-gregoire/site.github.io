  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-6 order-sm-2">
        ...
        <a href="http://localhost/Esso-plus/entretient.php" class="btn btn-primary btn-en-savoir-plus">Lire plus</a>
      </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-6">
        ...
        <a href="http://localhost/Esso-plus/jardin.php" class="btn btn-primary btn-en-savoir-plus">Lire plus</a>
      </div>
      <div class="col-sm-6">
        <div class="img">
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-6 order-sm-2">
        ...
        <a href="http://localhost/Esso-plus/transport.php" class="btn btn-primary btn-en-savoir-plus">Lire plus</a>
      </div>
      <div class="col-sm-6 order-sm-1">
        <div class="img">
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-6">
        ...
        <a href="http://localhost/Esso-plus/savonnerie.php" class="btn btn-primary btn-en-savoir-plus">Lire plus</a>
      </div>
      <div class="col-sm-6">
        <div class="img">
    ...
    <div class="row">
      <div class="col-sm-6 order-sm-2">
        ...
        Notre engagement envers le gardiennage et la sécurité se reflète dans notre approche holistique de la protection des biens et des personnes. En combinant nos compétences en gardiennage avec des pratiques sécuritaires, nous veillons à créer des environnements sûrs et protégés pour nos clients. Notre équipe dévouée travaille avec diligence pour garantir que chaque mission de gardiennage soit menée avec professionnalisme et vigilance, en respectant les normes de sécurité les plus strictes. En tant que spécialistes du gardiennage axés sur la sécurité, nous nous efforçons de fournir à nos clients une tranquillité d'esprit totale en assurant une surveillance constante et efficace de leurs biens et de leurs espaces.
          ...
          <a href="http://localhost/Esso-plus/securite.php" class="btn btn-primary btn-en-savoir-plus">Lire plus</a>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-6">
        ...
        <a href="nos_offres.html" class="btn btn-primary btn-en-savoir-plus">Nos formations</a>
      </div>
      <div class="col-sm-6">
        <div class="img">
