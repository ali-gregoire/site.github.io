    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <ul class="list-unstyled">
          <li><a href="http://localhost/Esso-plus/formation.php" class="text-white">Formation</a></li>
          <li><a href="http://localhost/Esso-plus/nos_offres.php" class="text-white">Nos Offres</a></li>
          <li><a href="http://localhost/Esso-plus/contact.php" class="text-white">Contact</a></li>
        </ul>
      </div>
    </div>
    <!-- En-tête -->
